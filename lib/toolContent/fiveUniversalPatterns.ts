...
export const fiveUniversalPatterns: Tool = {
  ...
  layered: {
    layer1: {
      wordCount: 43,
      body: 'Five patterns show up in almost everyone Karen and Ryan have worked with: the Overworker, the Soother, the Optimizer, the All or Nothing, and the Invisible. Most people have one primary and a secondary under stress. Name yours and the work gets specific.',
    },
    layer2: {
      kind: 'text-only',
      body: {
